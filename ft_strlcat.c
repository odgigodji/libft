...
size_t	ft_strlcat3(char *dst,const char *src, size_t dstsize)//antoha
{
	size_t dst_len;
...
int	main(void)
{
	...
	char dst2[40]= "0123456789";
	char src2[20]= "0123456789123456";
	char dst3[40]= "0123456789";
	char src3[20]= "0123456789123456";


	printf("orig:	   %lu,%s\n", strlcat(dst, src, n), dst);
	printf("apple my:  %lu,%s\n", ft_strlcat(dst1, src1, n), dst1);
	//printf("my:        %lu,%s\n", ft_strlcat1(dst2, src2, n), dst2);
	printf("ant my:    %lu,%s\n", ft_strlcat2(dst3, src3, n), dst3);
	printf("dst:%c\n", dst3[n - 2 ]);
